...
```bash
python3 implementations/dominik/turtle_to_yarspg.py examples/06-rdf-reifies.ttl
```

Select a mapping variant explicitly:

```bash
python3 implementations/dominik/turtle_to_yarspg.py --variant 1 examples/06-rdf-reifies.ttl
python3 implementations/dominik/turtle_to_yarspg.py --variant 2 examples/06-rdf-reifies.ttl
...
```bash
python3 implementations/dominik/turtle_to_yarspg.py --variant 3 examples/09-nested-triple-terms.ttl -o output.yarspg
```

Read Turtle from standard input:

```bash
cat examples/10-reifier-label.ttl | python3 implementations/dominik/turtle_to_yarspg.py --variant 3
```
